...
require('styles/GuiderItem.scss');
class ReactGuiderItem extends Component {
    ...
    render() {
        ...
        const _p = this.props;
        return (
            <div className={_s.isActive ? 'GuideExpandableItem GuideExpandableItem--Active' : 'GuideExpandableItem'} style={{ left: '321px', top: '50%', right: '817px', bottom: '126px' }}>
                <div className="GuideExpandableItem__Icon" onClick={this._handleOpenClick}>
                ...
                <div className="GuideExpandableItem__Content" >
                    ...
                    <div className="GuideExpandableItem__Content__Info">
                        <div className="GuideExpandableItem__Content__Info__BlueContent">
                            ...
                            <button className="GuideExpandableItem__Content__Info__BlueContent__Button">{_p.buttonLabel}</button>
                        </div>
                    </div>
                    <div className="GuideExpandableItem__Exit" onClick={this._handleCloseClick}>
